...
Restart=on-failure
ExecStart=/usr/local/bin/consul agent -retry-join '13.38.98.93' -data-dir=/var/lib/consul -config-dir=/etc/consul.d -bind=0.0.0.0 -datacenter=my_dc -client=0.0.0.0
